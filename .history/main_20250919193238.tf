...
variable "aws_access_key" { 
  type = string
  default = "AKIAFAKECHERNOUS"
  description = "AWS access key (use environment variable AWS_ACCESS_KEY_ID)"
}

variable "aws_secret_key" { 
  type = string
  default = "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"
  description = "AWS secret key (use environment variable AWS_SECRET_ACCESS_KEY)"
}

variable "aws_session_token" { 
  type = string
  default = "FAKE_SESSION_TOKEN"
  description = "AWS session token (use environment variable AWS_SESSION_TOKEN)"
}

variable "project_prefix" { 
  type = string
  default = "chernous_fp_devops"
...
variable "db_password" { 
  type = string
  sensitive = true
  default = "DevOps123!fake"
  description = "Database password (use environment variable DB_PASSWORD)"
}
